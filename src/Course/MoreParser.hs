...
satisfyAll ::
  ...
  -> Parser Char
satisfyAll lf =
  character >>= \x -> if and $ sequence lf $ x then
                       valueParser x
                     else failed
...
satisfyAny ::
  ...
  -> Parser Char
satisfyAny lf =
  character >>= \x -> if or $ sequence lf $ x then
                       valueParser x
                     else failed
